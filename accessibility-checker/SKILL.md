...
description: Check HTML pages for accessibility issues and WCAG 2.1 AA compliance. Automatically loads when working on HTML accessibility, ARIA labels, or screen reader compatibility.
---
